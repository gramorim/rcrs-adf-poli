...
public class CommandExecutorAmbulance
    ...
    switch ( scenarioInfo.getMode() ) {
      case PRECOMPUTATION_PHASE:
        this.pathPlanning = moduleManager.getModule(
            ...
            "poli.module.algorithm.PathPathPlanning" );
        this.actionTransport = moduleManager.getExtAction(
            "CommandExecutorAmbulance.ActionTransport",
            "poli.extaction.ActionTransport" );
        this.actionExtMove = moduleManager.getExtAction(
            "CommandExecutorAmbulance.ActionExtMove",
            "poli.extaction.ActionExtMove" );
        break;
      case PRECOMPUTED:
        this.pathPlanning = moduleManager.getModule(
            "CommandExecutorAmbulance.PathPlanning",
    ...
    switch ( this.type ) {
      ...
      case ACTION_AUTONOMY:
        if ( this.target != null ) {
          StandardEntity targetEntity = this.worldInfo.getEntity( this.target );
          if ( targetEntity instanceof Area ) {
            this.type = this.agentInfo.someoneOnBoard() == null ? ACTION_MOVE
                : ACTION_UNLOAD;
            return this.isCommandCompleted();
          } else if ( targetEntity instanceof Human ) {
            ...
            this.type = h.getStandardURN() == CIVILIAN ? ACTION_LOAD
                : ACTION_RESCUE;
            return this.isCommandCompleted();
          }
        }
